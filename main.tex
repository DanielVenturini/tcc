...
\include{capitulos/cap-coleta} % Esse capítulo e nome é apenas uma sugestão.
\include{capitulos/cap-draft} % Esse capítulo e nome é apenas uma sugestão.
%\include{capitulos/cap-traduzido} % Esse capítulo e nome é apenas uma sugestão.
