...
For each error in \textit{npm install} or \textit{npm test}, it was manually analyzed. The objective is to do a grouping of similar errors and category then. For example, Figure \ref{fig:error_category} shows two errors which one a function was renamed and the client try to access with the previous name.
