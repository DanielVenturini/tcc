...
Produzir códigos de teste é uma das maneiras mais importantes de garantir que o projeto esteja com o comportamento esperado. Entretanto, uma pesquisa realizada por \citeonline{uncovered} mostrou que os projetos \textit{Javascript} não contêm \textit{scripts} de teste em 22\% dos projetos estudados; 40\% dos projetos puramente clientes; e 3\% dos projetos servidores. Além disso, nem sempre os testes possuem cobertura total do projeto. Por esse fato, ha grande probabilidade de um erro ser descoberto apenas em tempo de execução pelos clientes. % continuar com o raciocínio da linguagem fracamente tipada e os atributos expostos ao cliente
