...
Para analisar esses pontos, foi utilizado uma base de dados com os nomes de todos os projetos do \Gls{NPM} em 2017. Ao todo, havia na base de dados \textit{366,629} nomes de projetos. A quantidade de amostras para realizar o estudo, com 95\% de confiança e 5\% de margem de erro, foi recuperada por uma calculadora amostral\footnote{https://pt.surveymonkey.com/mp/sample-size-calculator/} e chegou-se a um total de \textit{385} projetos. Dos \textit{366K} de projetos, a amostra de \textit{385} foram sorteados aleatóriamente com apenas um único critério: 
