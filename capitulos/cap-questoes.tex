...
\begin {figure} [h!]
   \centering
   \mbox {
        \subfigure[]{\label{fig:result_rq1_once_twice_three_1} \includegraphics[scale=0.5]{figuras/bc_documentation_mocha.pdf}}\quad
        \subfigure[]{\label{fig:result_rq1_once_twice_three_2} \includegraphics[scale=0.5]{figuras/bc_documentation_other.pdf}}
    }
